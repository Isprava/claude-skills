...
**Receives from:** `isp-intake` (confirmed inputs block)
...
These extra elements become gap candidates in `isp-gap-analysis` — they may represent undocumented decisions or design drift.
